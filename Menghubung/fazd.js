...
prefa = "#" 
    ...
    const ownerNumber = ["48729759866@s.whatsapp.net", "48699532476@s.whatsapp.net", "48729759866@s.whatsapp.net", "486995324763@s.whatsapp.net"]
    //const ownerName = ""
...
break
            ...
            case prefix+'sourcecode': {
              reply(`Bot ini menggunakan sc dari : Sc? Buy dong anjg🗿🖕`)
            }
            break
